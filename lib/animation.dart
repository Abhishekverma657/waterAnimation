                             ...
                             child: Container( height: 40,
                              width: 100,
                               decoration: BoxDecoration( color: Colors.green,
                                ...
                                child: Center(child: Text("Start",style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white , fontSize: 30),)),
                               ),
                           ),
                              SizedBox(width: 5,),
                              InkWell(
                                ...
                                child: Center(child: Text("Stop",style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white , fontSize: 30),)),
                                                     ),
                              )
              ...
              child: Stack(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Center(
                      child: Image.network('https://media.tenor.com/vR057wvo2tUAAAAi/fish-joypixels.gif')
                    ),
                  ),
                    ...
                    painter:  
                    MyPainter(animation1.value, animation2.value,
